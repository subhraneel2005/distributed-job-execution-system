...
## AI Tool Used
- **opencode** (CLI agent) — used for generating all implementation code, refactoring raw SQL to Drizzle ORM, debugging runtime errors, and creating the Postman collection.
